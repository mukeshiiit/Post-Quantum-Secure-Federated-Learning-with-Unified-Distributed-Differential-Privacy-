...
from src.analysis.rdp_accountant import run_privacy_accounting
...
def main():
    ...
    report = analyzer.generate_report([('PQ-FL (Proposed)', 'Vanilla FedAvg'), ('PQ-FL (Proposed)', 'FedProx'), ('PQ-FL (Proposed)', 'SCAFFOLD'), ('PQ-FL (Proposed)', 'DP-FedAvg'), ('PQ-FL (Proposed)', 'FL + Distributed Noise'), ('PQ-FL (Proposed)', 'FL + Secure Aggregation'), ('PQ-FL (Proposed)', 'FL + PQ Encryption Only')])
    ...
    print(report)
    print('\n[INFO] Computing Formal Privacy Budgets via Rényi Differential Privacy (RDP)...')
    privacy_results = run_privacy_accounting(config.OUTPUT_DIR)
    ...
    print('\n[INFO] Running Ring-LWE Key Establishment Scaling Analysis...')
